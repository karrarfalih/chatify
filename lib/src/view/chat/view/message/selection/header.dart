...
import 'package:chatify/src/view/common/animated_flip_counter.dart';
...
class SelectedMessagesHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<MessagesBloc, MessagesState, Map<String, Message>>(
        ...
        return AnimatedSwitcher(
          ...
          child: selecetdMessages.isEmpty
              ? const SizedBox.shrink(
                  key: ValueKey('no-selected-messages'),
                )
              : Container(
