                        ...
                        Expanded(
                          ...
                          child: KrPaginateFirestore(
                            ...
                            itemBuilder: (context, docs, i) {
                              ...
                              if (docs.length != i + 1) {
                                prevMsg = docs.elementAt(i + 1).data()
                                    as MessageModel;
                              }
                              if (i != 0) {
                                nextMsg = docs.elementAt(i - 1).data()
                                    as MessageModel;
                              }
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      CircularButton(
                                          ...
                                          onPressed: () {
                                            if (widget
                                                    .chat.editedMessage.value !=
                                                null) {
                                              controller.text = '';
                                            }
                                            widget.chat.editedMessage.value =
                                                null;
                                            widget.chat.replyMessage.value =
                                                null;
                                          })
                                    ],
                                  ),
                                  ...
                                  children: [
                                    ...
                                    PullDownButton(
                                        routeTheme: PullDownMenuRouteTheme(
                                          width: 140,
                                          backgroundColor: options.isDark
                                              ? Colors.black
                                              : Colors.white,
                                        ),
                                        itemBuilder: (context) => [
